                ...
                <form id="addProductForm" action="addProduct.php" method="post">
                    ...
                    <div class="row mb-3">
                        <div>
                            ...
                            <br>
                            <div class="col-sm-6">
                                <textarea class="form-control" id="newProductDescription" name="newProductDescription" value="<?php echo $newProductDescription;?>"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <div class="input-control">
                            ...
                            <br>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="receivedQuantity" name="receivedQuantity" value="<?php echo $receivedQuantity;?>">
                                <div class="error"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="input-control">
                            ...
                            <br>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="possibleMinimumQuantity" name="possibleMinimumQuantity" value="<?php echo $possibleMinumumQuantity;?>">
                                <div class="error"></div>
                            </div>
                        </div>
                    </div>
